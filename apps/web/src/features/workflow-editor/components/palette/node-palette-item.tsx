...
export function NodePaletteItem({
  ...
  return (
    <Button
      type="button"
      variant="ghost"
      className="group h-auto w-full justify-start rounded-lg border border-transparent p-2.5 text-left hover:border-primary/20 hover:bg-primary/[0.06] [content-visibility:auto]"
      onClick={() => {
        onAdd(definition);
      }}
    >
