...
| 14–15 | 246/61 | worker transport part 2 ↔ part 1 | Shared setup; moved PostgreSQL/Redis/BullMQ lifecycle to `apps/worker/test/support/transport.integration.support.ts`. |
...
The current exact scan reports 5 occurrences/159 aggregate duplicated lines
(0.17%) across 362 files/93,397 lines. Their pair identities, fragment hashes,
